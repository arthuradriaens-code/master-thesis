...
large ice sheets as shown in figure \ref{fig:GreenlandOP}\cite{OrthoGreenland}.
\begin{figure}
  \centering
...
\subsection{Hardware}
A station is illustrated in figure \ref{fig:detector}, the plan is to
...
Greenland (in the native tongue)} \cite{PlannedLay}. Looking closely at one such detector we see
...
\begin{figure}
  \centering
  \copyrightbox[r]{\includegraphics[width=0.85\textwidth]{SysDiagRNOG.png}}{\textcopyright Design and Sensitivity of the Radio Neutrino Observatory in Greenland (RNO-G) by J.A. Aguilar et. al}
  \caption{System diagram for a RNO-G station}
  \label{fig:SysDiag}
\end{figure}

A full system diagram for a RNO-G station is shown in figure \ref{fig:SysDiag}\cite{Aguilar_2021},
