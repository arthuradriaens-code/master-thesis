...
this figure the paths are \textit{direct and refracted}, designated DnR, but note that
\textit{direct and reflected} (at the surface) and \textit{refracted and refracted} are also
possible.
\begin{figure}
  \centering
...
Aside from these surface detectors there are also deep components of the
...
As a power source, battery banks are used which are charged via solar panels.
...
As mentioned in section \ref{sec:supernovae}, neutrinos from a supernova can
