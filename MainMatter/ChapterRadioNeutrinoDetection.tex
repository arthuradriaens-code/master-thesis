...
current exchange with the quarks\cite{NuRadioMc} as is also depicted in figure
...
too long and thus escape before they deposit all their energy in the ice or
...
\label{sec:Askaryan}
A particle shower formed through the previously described interaction in ice can emit
strong radio signals if two conditions are met:
\begin{itemize}
