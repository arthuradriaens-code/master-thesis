...
\begin{figure}[h!]
	...
	if it's an in-ice source due to the density gradient of the ice.}
\end{figure}
...
which we'll need to concern ourselves with, but to understand that effect we'll first
need to talk about Snell's law. 
