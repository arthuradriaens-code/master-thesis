...
\begin{figure}
	...
	\caption{Less neutrinos will be observed for higher energies\cite{NeutrinoFlux}}
...
\begin{figure}
	...
	\caption{Two electron neutrinos get released over the full fusion cycle\cite{FusionIllu}}
	\label{fig:SunFusion}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Iron is at the top and is thus the most stable atom\cite{IronIllu}}
