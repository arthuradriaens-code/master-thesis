...
\begin{figure}
	...
	\end{minipage}
\caption{The speed first lowers with larger normal vector length, reaching a minimum near 1 but the accuracy on timing gets worse after a length of 1. We thus
...
discussed criterion of sufficient solutions.
