...
\subsection{Reconstruction: Butterworth filters}
...
\end{figure}
An example path of a weather balloon is shown in figure (???), looking
...
data gets computed as is illustrated in figure (???)
