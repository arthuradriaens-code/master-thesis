...
The signal sent out by the weather balloon is a sinusoidal wave, meaning that
we can take a look at the recorded voltage i.f.o time and overlay a sine of
...
to zero as possible, the two fits are shown in figure \ref{fig:voltage67}.
\begin{figure}
	\begin{minipage}{0.49\textwidth}
...
Before actually fitting our signal there's one important consideration that
we haven't made yet: cable delay. We get the delay for the individual channels
with the get\_cable\_delay module, say our couble delays on channels a and b are $t_a^d$
and $t_b^d$, the recorded times (from fitting the sine) are thus of the form
$t^f = t + t^d$, our actual difference in timing is thus:
\begin{equation}
