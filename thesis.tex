...
As for the first statement, this might actually be the true fault, as if you try
to do the same procedure but with ch7 and a surface channel like ch13 the answer
you get is completely wrong (note that epsilon is then 8\%), instead of something 
close to 1.477 you get 1.08 as an index of refraction.

This might imply that the plane wave method can only be used for close-lying detectors
like what's the case in the phased array.
\chapter*{Conclusion}
