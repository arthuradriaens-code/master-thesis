...
be spaced closely as the attenuation length is quite short for visible spectrum
light in ice.  The proposed solution was to work with radiowave detectors,
leveraging the previously discussed Askaryan effect (see section \ref{sec:Askaryan}), which has been utilized in projects
like NuMoon\cite{numoon} project, ANITA\cite{ANITA},ARA\cite{ARA},RICE\cite{RICE}... .  Besides the advantage radiowaves have due to their abundance,
they can also propagate way further in ice than visible light making it
possible to space the individual detectors further apart. The proposed location
was Greenland, an island country in North America and part of the Kingdom of
Denmark which has large ice sheets.
\begin{figure}
  \centering
