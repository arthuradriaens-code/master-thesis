...
\end{align*}
Above we see the standard model lagrangian, consisting of the following parts: at the top the Generalized maxwell lagrangian,
...
the mass of the W\&Z bozons via the Brout Englert Higgs mechanism. The parts we concern ourselves with in this chapter
are the second and last parts.
\subsection{History}
...
energies. As the lagrangian would look like
\begin{equation}
...
This interaction lagrangian also doens't explain how this weak interaction violates parity as it couples only
to the left handed part of lepton- and baryon fields. Everything was finally ex
...
\end{equation}
Now starting from the simple kinetic lagrangian
\begin{equation}
...
\end{equation}
Now we wish to have gauge invariance over the whole lagrangian, 
i.e having
\begin{align}
...
\end{equation}
The rightmost term is a pseudoscalar, we thus see that this system breaks parity invariance if $ q_L \neq q_R$ .
