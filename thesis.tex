...
\end{figure}
An example path of a weather balloon is shown in figure \ref{fig:ExampleBalloonPathCrossing12}, looking
specifically at the height information recorded by the weather balloon in a
.root file using ROOT\footnote{\url{https://root.cern/}} (figure
...
\end{figure}
this is obvious.  It's quite difficult to work directly with the global
geographic coordinate system (longitudinal, latitude and elevation
coordinates), that's why we convert them to local ENU coordinates (north, east,
up) relative to the 'DISC' which is a point in the base camp located at
72.58279265212887 latitude, -38.45581495328228 longitude and 3251.9489147560234
elevation.
...
compute the angle ($\tan(\theta) = \frac{Hor.}{Vert.}$) doing this and recording
...
balloon gpx file recorded in the summer of 2022 and seeing where it gets
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{DensityBalloonWithZoom.pdf}
