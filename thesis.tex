...
more complex ice models, one such ray tracer will be explained in section
\ref{sec:Iterative} but this ray tracer has it's shortcomings. That's why the
development of a new ray tracer was needed which is the partial work of this
thesis and we'll get to that ray tracer in chapter \ref{chapter:hybrid}.
...
\textit{observer} sphere with the detector located at $\mathbf{X}_d$ at the
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{algoillu.pdf}
