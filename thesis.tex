...
NuRadioMC\cite{Glaser_2019}\cite{Glaser_2020} and NuRadioReco. NuRadioMC uses
...
code using the optimisation libraries, to come up with the algorithm that will
be discussed in this chapter: The hybrid ray tracer, in the source code called
the "hybrid minimizer" for which the source code can be found
