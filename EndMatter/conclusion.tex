...
\end{tabular}
\end{center}
It can be argued that this data shows a shortcoming of the exponential model.
Because of this we reason that there's a need to investigate the index-depth relation further.
...
it easy to improve on this work.  
